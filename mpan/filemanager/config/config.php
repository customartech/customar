...
if($_SESSION['userAccessKey']) 
    $access_key=$_SESSION['userAccessKey'];
else
    $access_key=rand();
...
$config = [
    ...
    *******************/
    ...
    'fixed_path_from_filemanager'             => ['../../uploadsThums/'], //fixed path of the image folder from the current position on upload folder
    'fixed_image_creation_name_to_prepend'    => [''], //name to prepend on filename
    'fixed_image_creation_to_append'          => ['_thums'], //name to appendon filename
    'fixed_image_creation_width'              => [400], //width of image
    'fixed_image_creation_height'             => [300], //height of image
    /*
    #             $option:     0 / exact = defined size;
    #                          1 / portrait = keep aspect set height;
    #                          2 / landscape = keep aspect set width;
    ...
    #                          4 / crop= resize and crop;
    */
    'fixed_image_creation_option'             => ['auto'], //set the type of the crop
    ...
    'relative_image_creation_name_to_append'  => ['_thumb'], //name to append on filename
    'relative_image_creation_width'           => [400], //width of image
    'relative_image_creation_height'          => [300], //height of image
    /*
    * $option:     0 / exact = defined size;
    *              1 / portrait = keep aspect set height;
    *              2 / landscape = keep aspect set width;
